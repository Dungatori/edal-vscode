...
import { a as MapPin, c as Check, d as AppWindow, i as Navigation, l as Building2, n as Wrench, o as Layers, r as Shield, s as DoorOpen, t as X, u as ArrowRight } from "../_libs/lucide-react.mjs";
import { t as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BzIXFSa7.js
...
var logo_default = "/assets/logo-G7qmRPbC.png";
var navItems = [
	{
		label: "Sherbimet",
		href: "#sherbimet"
...
var hero_default = "/assets/hero-CJExD5T9.jpg";
function Hero() {
...
var gallery = [
	{
		...
		category: "Duralumini",
		image: "/assets/gallery-1-wQJs0xQ3.jpg",
	...
	},
	{
		...
		category: "PVC",
		image: "/assets/gallery-2-BsLjpdL3.jpg",
	...
	},
	{
		...
		category: "Xham",
		image: "/assets/gallery-3-Dag8vrEt.jpg",
	...
	},
	{
		...
		category: "Fasada",
		image: "/assets/gallery-4-DqxKUq0Z.jpg",
...
function Gallery() {
	const categories = (0, import_react.useMemo)(() => {
		...
		return ["Te gjitha", ...Array.from(set)];
	}, []);
	const [active, setActive] = (0, import_react.useState)("Te gjitha");
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: categories.map((cat) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						className: `rounded-md border px-4 py-2 text-xs font-bold uppercase tracking-widest transition-all ${active === cat ? "border-primary bg-primary text-primary-foreground" : "border-border bg-background text-muted-foreground hover:border-primary hover:text-primary"}`,
						children: cat
					}, cat))
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: items.map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
						className: `group relative overflow-hidden rounded-lg border border-border bg-background ${i % 5 === 0 ? "lg:col-span-2 lg:row-span-2" : ""}`,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: `aspect-square overflow-hidden ${i % 5 === 0 ? "lg:aspect-auto lg:h-full" : ""}`,
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
									src: item.image,
									alt: item.title,
									loading: "lazy",
							...
							className: "absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-background via-background/60 to-transparent p-6 opacity-90",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									className: "mt-1 text-xl uppercase text-foreground",
									children: item.title
								}),
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContent, {
						...
						children: selected ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								...
								className: "p-6",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, { children: selected.title }), selected.description ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescription, { children: selected.description }) : null]
							})]
						}) : null
					})
				}),
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "EDAL eshte nje biznes familjar ne Valias qe prej vitesh ofron punime nga duralumini dhe PVC per shtepi, apartamente dhe biznese ne te gjithe zonen e Tiranes dhe Kamzes. Cdo projekt matet, prodhohet dhe montohet nga skuadra jone — pa nenkontraktore, pa surpriza."
				}),
