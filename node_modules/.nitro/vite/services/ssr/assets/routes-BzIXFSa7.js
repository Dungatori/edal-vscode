...
import { AppWindow, ArrowRight, Building2, Check, DoorOpen, Layers, MapPin, Navigation, Shield, Wrench, X } from "lucide-react";
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("nav", {
					...
					children: navItems.map((item) => /* @__PURE__ */ jsx("a", {
						href: item.href,
...
function FacebookIcon(props) {
	return /* @__PURE__ */ jsx("svg", {
		...
		xmlns: "http://www.w3.org/2000/svg",
		...props,
		children: /* @__PURE__ */ jsx("path", { d: "M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" })
	});
}
//#endregion
				...
				/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
					...
					children: [
						/* @__PURE__ */ jsx(SocialBtn, {
							href: site.contacts.whatsapp.link,
							label: "WhatsApp",
							children: /* @__PURE__ */ jsx(WhatsappIcon, { className: "h-5 w-5" })
						}),
						/* @__PURE__ */ jsx(SocialBtn, {
							href: site.contacts.instagram.link,
							label: "Instagram",
							children: /* @__PURE__ */ jsx(InstagramIcon, { className: "h-5 w-5" })
						}),
						/* @__PURE__ */ jsx(SocialBtn, {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("img", {
					...
					width: 1920,
					height: 1200
				}), /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-background/60 via-background/70 to-background" })]
			}),
			/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute right-0 top-24 hidden h-40 w-2 bg-primary md:block" }),
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-primary animate-pulse" }), "Punime cilesore ne Valias, Kamez"]
						}),
						/* @__PURE__ */ jsxs("h1", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("span", {
									...
									children: ["precizion", /* @__PURE__ */ jsx("span", { className: "absolute -bottom-2 left-0 h-1 w-full bg-primary" })]
								})
							]
						}),
						/* @__PURE__ */ jsx("p", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("a", {
								...
								children: [/* @__PURE__ */ jsx(WhatsappIcon, { className: "h-5 w-5" }), "Merr Ofertën në WhatsApp"]
							}), /* @__PURE__ */ jsxs("a", {
								href: "#galeria",
								...
								children: ["Shiko Galerinë ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
							})]
						}),
						/* @__PURE__ */ jsxs("div", {
				...
				children: services.map((service) => {
					...
					return /* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 h-0.5 w-0 bg-primary transition-all duration-500 group-hover:w-full" })
						]
					}, service.title);
				})
			})]
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("span", { className: "h-px w-8 bg-primary" }), kicker]
			}),
			/* @__PURE__ */ jsx("h2", {
...
function Gallery() {
	...
	const [active, setActive] = useState("Te gjitha");
					...
					children: /* @__PURE__ */ jsx(DialogContent, {
						...
						children: selected ? /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("img", {
								...
								className: "p-6",
								children: [/* @__PURE__ */ jsx(DialogTitle, { children: selected.title }), selected.description ? /* @__PURE__ */ jsx(DialogDescription, { children: selected.description }) : null]
							})]
						}) : null
					})
				}),
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [
				...
				/* @__PURE__ */ jsx("ul", {
					...
					children: points.map((p) => /* @__PURE__ */ jsxs("li", {
				...
				className: "relative",
				children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 -translate-x-3 translate-y-3 border-2 border-primary" }), /* @__PURE__ */ jsxs("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(SectionHeader, {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs(InfoCard, {
						...
						children: [/* @__PURE__ */ jsx(Navigation, { className: "h-4 w-4" }), "Merr Drejtimet"]
					})]
				}), /* @__PURE__ */ jsx("div", {
...
function Contact() {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-x-0 top-0 h-2 diagonal-stripes opacity-20" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: channels.map(({ key, label, handle, href, cta, Icon }) => /* @__PURE__ */ jsxs("a", {
						href,
						target: "_blank",
						rel: "noreferrer",
